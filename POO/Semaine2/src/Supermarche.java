...
class Achat {
    ...
    public double prix(){
        ...
        return article.getPrixUnitaire() * quantite * promotion;
    }

    public String afficher() {
        String affichage =  article.getNom()+" : "+article.getPrixUnitaire()+" x "+quantite+" = "+prix()+" Frs ";
        if(article.isEnSolde()){
            affichage += "(1/2 prix)";
        }
...
class Caisse {
    ...
    public void scanner(Caddie caddie){
        ...
        for(Achat achat : caddie.getAchats()){
            System.out.println(achat.afficher());
            prix += achat.prix();
        }
        montantTotal += prix;
        System.out.println();
        System.out.println("Montant à payer : "+prix+" Frs");
        System.out.println("=========================================");
    }
